...
import { Shape, ShapeTypes, Rect, Line, Point } from '../Shape.js'
...
export default class Circle implements Shape {
  ...
  static intersectsCircle(self: Circle, other: Circle) {
    const dist2 = Math.abs((self.x - other.x) ** 2 + (self.y - other.y) ** 2)
    return dist2 < ((self.r + other.r) * (self.r + other.r))
  }

  static intersecstLine(circle: Circle, line: Line): never {
