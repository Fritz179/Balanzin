...
import { Shape, ShapeTypes, Rect, Circle, Point } from '../Shape.js'
...
export default class Line implements Shape {
  ...
  static intersectsLine(self: Line, other: Line): boolean {
    return !(
      self.x1 > other.x2 ||
      self.x2 < other.x1 ||
      self.y1 > other.y2 ||
  ...
  static intersectsPoint(line: Line, point: Point): never {
