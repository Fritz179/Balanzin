...
// nal render al controla i fiöi, sa i gan _posChanged e i gan an buffer, return buffer
// altriment ciama render
// tö via al cahnged noma dopu al render(al la fa al parent)

// Block al ga [x, y, w, h] e funzion par al moa [setPos, setSize, setRight, left, bottom]

// Frame al ga [xm, ym, cahnged(_posChanged)] e funzion cuma [update, render, onKey, onMouse]
...
// Entity al ga [spriteDir, spriteAction, spriteFrame, cahnged(_spriteChanged)] e [render]
...
// sa al ven ciamu render al ven ciamu al vol di ca an fradel le cambiu
...
// changed al po esa resettu noma dopu ave ciamu al render, dopu ave disegnu tüt
...
// Layer
//    fixedUpdate.post => check fot poschanged
//    render.pre => set this.sprite to parentSprite

// SpriteLayer
//    update.post => call changed to all children and get if updated
//    fixedUpdate.post => update child phisics
//    render.post => if ret !== false => get sprite of children and set them to changed = false
